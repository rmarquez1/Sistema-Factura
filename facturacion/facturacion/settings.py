...
import os, sys
os.environ['DJANGO_SETTINGS_MODULE']='facturacion.settings'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ALIMENTOS-DAVID.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '!p*xl+epi-w0s4(*+16@(1(5-940jc!b$v*(i5xr8_r=quzbba'
...
INSTALLED_APPS = (
    ...
    'facturacion.apps.proveedores',
    'facturacion.apps.participante',
